...
Questo progetto nasce con l'obiettivo di analizzare quantitativamente gli effetti sul paesaggio costiero e vegetale prodotti dal devastante parossismo vulcanico avvenuto sull'isola di Stromboli il 3 luglio 2019[cite: 1]. L'esplosione ha innescato una serie di incendi secondari causati dalla ricaduta di materiale balistico incandescente che ha colpito duramente i fianchi dell'edificio vulcanico, distruggendo ampie porzioni di macchia mediterranea[cite: 1].
